...
if (isset($_GET['action']) && isset($_GET['id'])) {
    ...
    try {
        if ($action == 'read') {
            ...
            $pdo->prepare("UPDATE contact_messages SET status = 'unread' WHERE id = ?")->execute([$message_id]);
    ...
    <div class="admin-container">
        ...
        <div class="sidebar">
            ...
            <div class="nav-menu">
                ...
                <a href="contact_messages.php" class="active"><i class="fas fa-envelope"></i> Contact Messages</a>
        ...
        <div class="main-content">
            ...
            <div class="card">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($message['status'] == 'read'): ?>
                                    <button class="action-btn unread-btn" onclick="window.location.href='contact_messages.php?action=unread&id=<?php echo $message['id']; ?>'">
                                        <i class="fas fa-envelope"></i> Mark Unread
                                    </button>
                                <?php else: ?>
                                    <button class="action-btn read-btn" onclick="window.location.href='contact_messages.php?action=read&id=<?php echo $message['id']; ?>'">
                                        <i class="fas fa-envelope-open"></i> Mark Read
                                    </button>
                                <?php endif; ?>
                                <button class="action-btn delete-btn" onclick="if(confirm('Are you sure you want to delete this message?')) { window.location.href='contact_messages.php?action=delete&id=<?php echo $message['id']; ?>' }">
                ...
                <div class="pagination">
                    <?php if ($page > 1): ?>
                        <a href="contact_messages.php?page=<?php echo $page - 1; ?>">&laquo;</a>
                    <?php endif; ?>
                    
                    <?php for ($i = 1; $i <= $total_pages; $i++): ?>
                        <a href="contact_messages.php?page=<?php echo $i; ?>" <?php echo $i == $page ? 'class="active"' : ''; ?>><?php echo $i; ?></a>
                    <?php endfor; ?>
                    
                    <?php if ($page < $total_pages): ?>
                        <a href="contact_messages.php?page=<?php echo $page + 1; ?>">&raquo;</a>
                    <?php endif; ?>
                </div>
                <?php endif; ?>
            </div>
